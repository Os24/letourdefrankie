            ...
            <Col>
              ...
              <Accordion className="faq-accordion">
                ...
                <Accordion.Item eventKey="1">
                  <Accordion.Header>¿Qué categorías hay?</Accordion.Header>
                  <Accordion.Body>
                    Individual (Femenino, Masculino y Libre) y Duplas, donde
                    ambos corredores deben permanecer juntos durante toda la
                    ruta.
                  </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="3">
                  ...
                  <Accordion.Body>
                    130 horas para completar la ruta completa, desde la
                    salida en CDMX hasta la meta en Puerto Escondido, Oaxaca,
                    pasando por 5 checkpoints obligatorios.
                  </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="5">
                  ...
                  <Accordion.Body>
                    Cada corredor porta un dispositivo de rastreo durante
                    todo el recorrido; debe permanecer encendido en todo
                    momento y entregarse en la meta al finalizar.
                  </Accordion.Body>
                </Accordion.Item>
